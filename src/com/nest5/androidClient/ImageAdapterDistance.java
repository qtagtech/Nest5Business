...
public class ImageAdapterDistance extends ArrayAdapter<Deal> {
    ...
    public ImageAdapterDistance(Context context, Deal[] result, ListView _list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
		...
		float distance = currentDeal.distance;
            ...
            default:
                ...
                if (position == 0) {
                    needSeparator = true;
                		...
                		float previous = result[position - 1].distance;
                		//Log.i("TEST",previous);
                    if ((distance - previous) >= 500/1000) {
                        needSeparator = true;
        ...
        if (needSeparator) {
        	...
        	else
        	{
        		...
        		else
        		{
        			if(distance <= 1)
        			{
        				title = "Relativamente Cerca";
        			}
        			else
        			{
        				title = "A más de 1 km de distancia";
        			}
        				
        		}
        	}
            viewCache.getSeparatorView().setText(title);
       ...
       // String imageUrl = imageAndText.getImageUrl();
        ...
        {
        	description = cantPromos > 1 ? cantPromos+" promociones o beneficios a "+Util.displayDistance(distance) : "1 promoción o beneficio a "+Util.displayDistance(distance);
        }
