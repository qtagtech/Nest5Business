...
public class ImageAdapterMyCoupon extends ArrayAdapter<AnswerCoupon> {
    ...
    private AnswerCoupon[] result;
    private Context mContext;
 
    public ImageAdapterMyCoupon(Context context, AnswerCoupon[] result, ListView _list) {
