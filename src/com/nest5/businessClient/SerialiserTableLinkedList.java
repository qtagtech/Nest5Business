...
public class SerialiserTableLinkedList implements JsonSerializer<LinkedList<LinkedHashMap<Registrable,Integer>>>, JsonDeserializer<LinkedList<LinkedHashMap<Registrable,Integer>>>{
	@Override
