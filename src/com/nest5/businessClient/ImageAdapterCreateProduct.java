...
public class ImageAdapterCreateProduct extends BaseAdapter {
    ...
    public ImageAdapterCreateProduct(Context c,List<Ingredient> _items,LayoutInflater _inflater,OnTouchListener touchListener/*,OnClickListener cListener*/) {
        mContext = c;
        items = _items;
        inflater = _inflater;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
     ...
     // Inflate the views from XML
       ...
       // buttonView.setOnClickListener(cListener);
        ...
        priceView.setText(String.valueOf(Initialactivity.roundWhole(item.getPricePerUnit() * (1 + item.getTax().getPercentage()))));
