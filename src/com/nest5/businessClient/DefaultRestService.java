...
public class DefaultRestService{
	...
	public DefaultRestService(Handler mHandler, Context mContext, String url){
	 ...
	 * specifies the HTTP Verb to use. Must use either DefaultRestService.GET or DefaultRestService.POST
	 * <p>
	 ...
	 * <p>
	 * @param	method	The type of HTTP request to make. Can be either DefaultRestService.GET or DefaultRestService.POST
	 */
