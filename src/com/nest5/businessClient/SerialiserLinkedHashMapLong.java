...
public class SerialiserLinkedHashMapLong implements JsonSerializer<LinkedHashMap<LinkedHashMap<Registrable,Integer>,Long>>, JsonDeserializer<LinkedHashMap<LinkedHashMap<Registrable,Integer>,Long>>{
	@Override
	public JsonElement serialize(
			LinkedHashMap<LinkedHashMap<Registrable, Integer>,Long> list,
			Type type, JsonSerializationContext context) {
		final JsonArray jsonVentas = new JsonArray();
		for(Map.Entry<LinkedHashMap<Registrable,Integer>, Long> orden : list.entrySet()){
	...
	@Override
	public LinkedHashMap<LinkedHashMap<Registrable, Integer>,Long> deserialize(
		...
		LinkedHashMap<LinkedHashMap<Registrable, Integer>,Long> lista = new LinkedHashMap<LinkedHashMap<Registrable,Integer>,Long>(); 
		for(JsonElement venta : (JsonArray) ventas){
			...
			Long valor = ((JsonObject) venta).get("values").getAsLong();
