...
/**
 * Entity mapped to table INGREDIENTE.
 */
public class Ingrediente {
    ...
    private transient IngredienteDao myDao;
    ...
    public Ingrediente(Long id, long syncId, String name, Double costPerUnit, Double pricePerUnit, java.util.Date Date, Long impuestoId) {
        this.id = id;
        this.syncId = syncId;
        this.name = name;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getIngredienteDao() : null;
    }
