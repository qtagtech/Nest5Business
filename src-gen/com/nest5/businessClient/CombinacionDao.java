...
/** 
 * DAO for table COMBINACION.
*/
public class CombinacionDao extends AbstractDao<Combinacion, Long> {

    public static final String TABLENAME = "COMBINACION";

    /**
     * Properties of entity Combinacion.<br/>
    ...
    */
    ...
    public CombinacionDao(DaoConfig config) {
        super(config);
    }
    
    public CombinacionDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'COMBINACION' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'COMBINACION'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Combinacion entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(Combinacion entity) {
    ...
    /** @inheritdoc */
    @Override
    public Combinacion readEntity(Cursor cursor, int offset) {
        Combinacion entity = new Combinacion( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Combinacion entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Combinacion entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Combinacion entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" FROM COMBINACION T");
    ...
    protected Combinacion loadCurrentDeep(Cursor cursor, boolean lock) {
        Combinacion entity = loadCurrent(cursor, 0, lock);
    ...
    public Combinacion loadDeep(Long key) {
        assertSinglePk();
        if (key == null) {
            return null;
        }
    ...
    public List<Combinacion> loadAllDeepFromCursor(Cursor cursor) {
        int count = cursor.getCount();
        List<Combinacion> list = new ArrayList<Combinacion>(count);
    ...
    protected List<Combinacion> loadDeepAllAndCloseCursor(Cursor cursor) {
        try {
    ...
    public List<Combinacion> queryDeep(String where, String... selectionArg) {
